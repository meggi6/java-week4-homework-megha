 ...
 * 2. Write a class with the name Cuboid that extends Rectangle class. The class needs one
 ...
 * all of type double. It needs to call the parent constructor and initialize a height field.
